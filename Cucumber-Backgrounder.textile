...
This might have been the easiest thing to do but, is was not the best thing to do.  In my experience framework generated scaffolds provide only a comforting illusion of progress through voluminous production of boilerplate code.  And all too frequently said code is, for all intents and purposes, worthless; save only as an example of proper syntax and even then the syntax is oft-times of dubious quality.
