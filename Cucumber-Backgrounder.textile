...
Scaffolding provides a comforting illusion of progress through its voluminous production of template code.  Said code being, for all intents and purposes, worthless save only as an example of proper syntax.  By all means take a look at the generated code to obtain some idea of how things should look when you write your own features, but do not expect your project to design itself. 
