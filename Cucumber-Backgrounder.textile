...
A cleaner way of doing this is to create a class that contains only your addon methods and then instantiate it inside the Cucumber World.  Something like this:
