...
Of course, when you are testing the login user interface the ugly approach is unavoidable.
...
My rule of thumb is that if a step definition requires more than eight to ten lines of code, and it is called from any other step definition, then its contents probably should be refactored out into a custom method.
