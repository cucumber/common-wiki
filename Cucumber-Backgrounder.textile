...
That is acceptable usage in your step_definitions because your users are never going to see how ugly it looks.
...
<pre><code>Cucumber::Rails::World.class_eval do
...
For instance, "Bob" could, and should, be authenticated in the step_definition thus:
<pre><code>
When /"Bob" logs in/ do |user|
