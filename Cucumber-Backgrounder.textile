...
Given you have installed the gem named "rails"
...
Then it should create the directory ./features
  And it should create the file ./features/features.feature
  And it should create the directory ./features/step_definitions
  And it should create the file ./features/step_definitions/web_steps.rb
  And it should create the directory ./features/support
  And it should create the file ./features/support/env.rb
  And it should create the file ./features/support/paths.rb
  And it should create the file ./lib/tasks/cucumber.rake
  And it should create the file ./config/environments/environment cucumber.rb
  And it should modify ./config/database.yml
  .  .  .
</pre>
