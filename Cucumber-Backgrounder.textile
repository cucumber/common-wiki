...
Remind yourself, frequently, that somebody else is going to have to understand what you write today some years hence and that in all likelihood you will not be around to explain it.  Do not be overly clever and needlessly terse in Feature files and Step Definitions.  Save the coding-fu for the the code and leave the tests plain, unadorned, and easy to understand.
