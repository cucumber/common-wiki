...
Unless you are knowlegable enough to be using mocks and stubs then I consider it best to begin with a Rails migration file for the model you are testing followed by:<pre><code>rake db:migrate
