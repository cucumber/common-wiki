...
Note that in this document I often use the terms <em>test</em> and <em>testing</em> where "BDD practictioners":http://dannorth.net/introducing-bdd prefer the term <em>behaviour</em>.  When I write test I am in fact discussing verifying behaviour regardless of what word I use.
