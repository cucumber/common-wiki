...
Note that in this document I often use the terms <em>test</em> and <em>testing</em> where "BDD practictioners":http://dannorth.net/introducing-bdd prefer the terms <em>behaviour</em> or <em>expectation</em>.  When I write test I am in fact discussing expressing and verifying expected behaviour.
