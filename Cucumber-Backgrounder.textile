...
A final word of advice: Get the <em>Cucumber Book</em> from the Pragmatic Programmers and <strong><em>read it</em></strong>; carefully.  Details are found at http://pragprog.com/book/hwcuc/the-cucumber-book 