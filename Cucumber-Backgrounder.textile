...
Which raises another interesting point.  If more than one of these matchers are defined anywhere in any of your step_definitions.rb files, and not necessarily in the same file mind you, then cucumber complains that it found multiple step definition matches for a single feature step and forces you to distinguish them.
