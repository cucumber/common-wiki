...
This might be the easiest thing to do, but not necessarily the best thing to do.  Generating scaffolds provides a comforting illusion of progress through its voluminous production of boilerplate code.  Said code being, for all intents and purposes, worthless save only as an example of proper syntax and even the syntax is sometimes dubious.  By all means take a look at the generated code to obtain some idea of how things should look when you write your own features, but do not expect your project to design itself. 
