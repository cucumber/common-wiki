...
running the command <code>rake cucumber:wip</code> will run only the steps contained inside Scenario B only, while running <rake cucumber:ok</code> will run the steps within all Scenarios other than B.
