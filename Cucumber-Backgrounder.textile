...
While Capybara is emerging as the preferred testing method it does not play well with Rails' 2.x own built-in Test Assertions.  In particular, whenever Capybara is required into a Cucumber World then the response.body method of Rails Test::Unit is removed.  
