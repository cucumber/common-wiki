...
Frankly, except for the most trivial of cases, you should always use test data obtained from actual production environments.  You are, after all, embarked on an adventure. To discover how to make thing work.  However, to discover what actually works requires more than a passing familiarity with what is real.  And made-up data is not reality.  Since it comes from the same source as most of your errors will, your own limited understanding of the problem domain,  manufactured data is always suspect. 
