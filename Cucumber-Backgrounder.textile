...
Oh, and never, ever, write a step definition for a clause that is not already present in one of your features.  Most such step definitions will end up as unused "cruft":en.wikipedia.org/wiki/Cruft that somebody at sometime will end up discarding anyway.   In any case, those few that are not discarded will need rework when they are finally employed.  It is best to wait until the need each for step definition is both evident and pressing.
