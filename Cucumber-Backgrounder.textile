...
Before anything else make sure that you have the <em>cucumber-rails</em> gem added to the <code>:test</code> group of your project's Gemfile and that you have run <code>bundle install</code>:
