...
A cleaner way of doing this that avoids using the evil <strong><em>eval</em></stron> method is to create a class that contains only your addon methods and then instantiate it inside the Cucumber World.  Something like this:
