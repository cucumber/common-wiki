...
Windows users using MRI (the one-click ruby installer) will have to install the <code>win32console></code> gem. (Currently "this might not work on Ruby 1.9":http://groups.google.com/group/cukes/browse_thread/thread/14a4ded4d083f7c -- try it out).

If you're on JRuby you currently have to use "wac":http://github.com/aslakhellesoy/wac (Windows ANSI Color--probably works for MRI as well).

ex:

@cucumber --color plugins\project\features\drb_service.feature | wac@