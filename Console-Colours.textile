...
_Don't attempt to set it in your <code>support/env.rb</code> file or any other Ruby file. It must be defined _before_ Cucumber starts. You can do it in your Rakefile with <code>ENV['CUCUMBER_COLORS'] = '...'</code>_
