Most Gherkin lines begin with a keyword and whitespace. Every <tt>.feature</tt> file consists of a feature header -- line starting with keyword *Feature* followed by free indented text -- optional background and a list of scenarios. You can write whatever you want up until the first scenario, which starts with the word *Scenario* (or localized equivalent) on a new line.  Gherkin is localized for [[Spoken Languages|dozens of languages]].
