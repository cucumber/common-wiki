...
The table argument to the <code>diff!</code> method can be another Table, an Array of Array or an Array of Hash (similar to the structure returned by #hashes).
