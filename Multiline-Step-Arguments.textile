...
<pre><code>Given a blog post named "Random" with the following body in Markdown
  """
  Some Title, Eh?
  ==============
...
<pre><code>Given /^a blog post named "([^\"]*)" with the following body in Markdown$/ do |title, markdown_content|
