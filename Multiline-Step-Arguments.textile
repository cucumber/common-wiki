...
For a more complex example, look at "this commit":http://github.com/aslakhellesoy/cucumber-rails/commit/e03ca01556adcb21354046107f7c7803efb8b3df which uses a Proc to extract each column from the HTML. (This is a spec for the internal <code>_tableish</code> method - in your own code you want to use <code>tableish</code> instead and skip the 1st <code>html</code> argument).
