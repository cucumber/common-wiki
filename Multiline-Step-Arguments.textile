...
* An <code>Array</code> containing <code>Hash</code>es with <code>String => String</code> (similar to the structure returned by #hashes).
...
Similarly, you can easily turn Rails ActiveRecord objects into a table:
...
If you are not using Webrat or ActiveRecord, you can build up an Array of Array of String yourself.
