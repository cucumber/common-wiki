"FunFX":http://wiki.github.com/peternic/funfx is a Watir / SafariWatir / FireWatir extension that lets you talk to a Flex application straight from Ruby. Here is how you can write Cucumber step definitions that use FunFX:
