...
*IMPORTANT* _As of Sept 12 there are problems with the gem. Please get the code via Git (or download a tarball) and build the gem yourself. I'm investigating what the problem is. --Aslak_
