<div style="float:right; margin: 0 0 0.5em 1em"><a href="http://www.pragprog.com/titles/achbd"><img src="http://shared2.pragprog.com/images/covers/190x228/achbd.jpg" style="border: 1px solid silver"/></a></div>
...
Take a look at the "examples":http://github.com/aslakhellesoy/cucumber/tree/master/examples. In each subdirectory you can run the <code>cucumber</code> command. If an example directory has a <code>Rakefile</code>, run <code>rake -T</code> to see what rake tasks are available.
...
There are several ways to get yourself started in writing tests, depending somewhat on the architecture of your application.  Digest [[Cucumber Backgrounder]] first (especially if you work with "Rails":http://wiki.github.com/aslakhellesoy/cucumber/ruby-on-rails).  Then you might want to read more about [[Gherkin]], the Cucumber language and peek into specific topics (below) regarding the various aspects of setting up Cucumber.
...
*** "Watir":http://watir.com/ - Drives IE (Windows only) and Firefox (Windows, OSX, GNU/Linux), see: [[Setting up FireWatir]]
*** "FireWatir":http://watir.com/ - Drives Firefox on Windows, OSX and GNU/Linux
