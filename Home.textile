<div style="float:right; margin: 0 0 0.5em 1em"><a href="http://www.pragprog.com/titles/hwcuc"><img src="http://cukes.info/images/hwcuc-190x228.jpg" style="border: 1px solid silver"/></a></div>

!https://cukes.info/images/cucumber.png!:http://cukes.info/ 

!https://cukes.info/images/cucumber.png(Cucumber Logo)!
...
There are several ways to get yourself started in writing tests, depending somewhat on the architecture of your application.  Digest [[Cucumber Backgrounder]] first (especially if you work with "Rails":http://wiki.github.com/cucumber/cucumber/ruby-on-rails).  Then you might want to read more about [[Gherkin]], the Cucumber language and peek into specific topics (below) regarding the various aspects of setting up Cucumber.
...
** Adobe Flex: [[FunFX|FunFX and Flex]], [[Melomel|http://melomel.info/Cucumber]]
** [[Python]]
** Perl: [[Test::BDD::Cucumber|https://metacpan.org/module/Test::BDD::Cucumber]] [[Test::Pcuke|http://search.cpan.org/~crusoe/Test-Pcuke-0.000006/lib/Test/Pcuke.pm]]
** Erlang: [[cucumberl|https://github.com/membase/cucumberl]], [[kucumberl|https://github.com/openshine/kucumberl]]
** PHP: [[Behat |http://behat.org/]] (with [[Mink |http://mink.behat.org/]] for browser testing)
** Web apps in any language: Drive a full or headless browser using one of these
*** "Webrat":http://github.com/brynary/webrat/tree/master/ - Ruby acceptance testing for web applications
*** "Capybara":http://github.com/jnicklas/capybara - Acceptance testing framework with a webrat-like API and support for multiple backends, including RackTest, Selenium, Celerity and Culerity
...
*** [[PHP]]
*** "WebDriver":http://code.google.com/p/selenium/wiki/RubyBindings - Drives IE, Firefox, Chrome
*** "Watir":http://watir.com/ - Drives IE (Windows only) 
*** "Watir WebDriver":http://watirwebdriver.com/ - Drives Firefox, Chrome, IE & Opera - optionally headless - Linux/Mac/Windows: "the most elegant way to use webdriver with ruby"
...
*** "Mechanize":https://github.com/sparklemotion/mechanize - Runs a headless browser (any OS)
...
If you think this sounds annoying, try it out anyway. You'll end up writing better, less coupled (and less) code this way. Trust me. Work outside-in (the outside being the feature, the inside being the low level code). Do it the "BDD":http://en.wikipedia.org/wiki/Behavior_driven_development way.
...
Here is an example taken from an IRC chat session in "#cucumber":http://webchat.freenode.net/?channels=cucumber:
...
* [[Contributing]]
* [[Get in touch]]
* "Search":http://www.google.com/cse/home?cx=007890526056528126221%3A-iaos5ttkpu&ie=UTF-8 this wiki, cukes.info, IRC rooms and mailing lists.