...
Cucumber is a tool that provides software teams with a "Business Readable, Domain Specific Language":http://martinfowler.com/bliki/BusinessReadableDSL.html for describing software's behaviour. Plain text documents written in Cucumber's DSL can be executed as automated functional tests and describe how the features in the system behave. Here is an example:
