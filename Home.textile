...
* Java: Use "JRuby":http://binil.wordpress.com/2008/10/29/running-cucumber-on-jrubymaven/ 
* .NET: Use "IronRuby":http://www.patrickgannon.net/archive/2008/10/23/bdd-style-feature-tests-using-ironruby-and-rspeccucumber.aspx
* Flex: Use "FunFX":http://github.com/peternic/funfx
* Web apps in any language: Use "Watir":http://wtr.rubyforge.org/, "Selenium":http://selenium.seleniumhq.org/ or "Celerity":http://celerity.rubyforge.org/
