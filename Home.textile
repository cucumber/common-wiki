...
Cucumber is a tool that can execute plain-text documents (readable by business people) as automated functional tests. The language that Cucumber understands is called [[Gherkin]]. Here is an example:
...
** [[Spork and --drb]] to distribute your test runs
