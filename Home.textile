...
*** "Watir WebDriver":http://watirwebdriver.com/ - Drives Firefox, Chrome, IE & Opera - optionally headless - Linux/Mac/Windows: "the most elegant way to use webdriver with ruby"  [[Setting up FireWatir]]
...
*** "Mechanize":http://mechanize.rubyforge.org/mechanize/ - Runs a headless browser (any OS)
