...
While Cucumber can be thought of as a "testing" tool, the intent of the tool is to support "BDD":http://behaviour-driven.org/. This means that the "tests" (plain text feature descriptions with scenarios) are typically written before anything else, and  the production code is then written "outside-in":http://dannorth.net/whats-in-a-story, to make them pass.
...
There are several ways to get yourself started in writing tests, depending somewhat on the architecture of your application.  Digest [[Cucumber Backgrounder]] first (especially if you work with Rails).  Then you might want to peek into specific topics regarding the various aspects of setting up Cucumber.

* Runtime environments and Cucumber
** [[JRuby and Java]]
** [[IronRuby and .NET]]
** [[IronRuby and Mono]]
* Test "drivers" and targets
** [[Ruby on Rails]]
** [[Merb]]
** [[Sinatra]]
** [[FunFX and Flex]]
