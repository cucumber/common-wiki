...
** "Celerity":http://celerity.rubyforge.org/ - Runs a headless browser with Javascript support. Examples "here":http://github.com/alvinschur/celerity-examples/tree/master
