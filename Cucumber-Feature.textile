...
Cucumber has its own Step Definitions that make it relatively easy to write features for Cucumber itself. A good place to start is to look at the "features/exception_in_after_block.feature":http://github.com/cucumber/cucumber/blob/master/features/exception_in_after_block.feature file.
