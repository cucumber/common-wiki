...
If you're using [[Ruby on Rails]] it's easy to turn off transactions for a feature or particular scenarios (if you're on 0.3.103 or above), just use the <code>@no-txn</code> tag, e.g.
