...
_(This paragraph is outdated. If you use <code>@no-txn</code> with Rails you now get the behavior described below out of the box. Details in http://github.com/aslakhellesoy/cucumber-rails/blob/master/lib/cucumber/rails/active_record.rb)_
