...
The details of the protocol are documented in "the Wire Protocol Features":https://github.com/cucumber/cucumber-ruby/blob/v2.1.0/features/docs/wire_protocol/invoke_message.feature.
