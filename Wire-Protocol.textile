...
When you run your features, Cucumber will then connect to this TCP socket, ask the service at the other end about the the steps it has defined, and subsequently tell the service to invoke then if necessary. It's perfectly feasible to have a mix of step definitions - some implemented in Ruby as normal, and some implemented over the wire.
