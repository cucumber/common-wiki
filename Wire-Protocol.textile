...
The details of the protocol are documented in "the Wire Protocol Features":https://github.com/cucumber/cucumber/blob/master/features/docs/wire_protocol/invoke_message.feature.
