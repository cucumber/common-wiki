...
By default the plugin will run all the features in the features dir, and without color.  To change the way the features are run with autotest create two profiles in your [[cucumber.yml]]: 
