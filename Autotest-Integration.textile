This wiki is scheduled to be [removed](https://github.com/cucumber/docs.cucumber.io/issues/144).
Please check out the current [Cucumber docs](https://docs.cucumber.io/).
