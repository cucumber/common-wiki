...
If AUTOFEATURE is not set you will get the warning <code>(Not running features.  To run features in autotest, set AUTOFEATURE=true.)</code>. Set AUTOFEATURE=false to silence this warning after "pull request 354":https://github.com/cucumber/cucumber/pull/354 is merged.
