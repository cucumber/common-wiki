...
*WARNING:* This guide is for setting up Selenium version 1, and is somewhat obsolete. We recommend you use Selenium 2 (WebDriver) instead, through Capybara if you're on Rails.
