...
And for all the Rails users out there - we recommend using a "Given with a multiline table argument":http://github.com/cucumber/cucumber-rails-test/blob/master/features/manage_lorries.feature to "set up records":http://github.com/cucumber/cucumber-rails-test/blob/master/features/step_definitions/lorry_steps.rb instead of fixtures. This way you can read the scenario and make sense out of it without having to look elsewhere (at the fixtures).
