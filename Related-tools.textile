...
|"rails_template":http://github.com/hectoregm/rails-templates/tree/master| Rails Template using Authlogic that comes with Cucumber features|
...
|"rSquery":http://github.com/caifara/rsquery/tree/master|Using jquery matchers and more in selenium, taking the pain out of writing selenium tests.|
