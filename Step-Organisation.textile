...
While it might be tempting to implement When steps to just look in the database - resist the temptation. You should verify some kind of outcome that is observable for the user (or external system) and databases usually are not.
