Communication within a team always works better when people can use their spoken language. Cucumber supports over "30 spoken languages":../cucumber/tree/master/lib/cucumber/languages.yml. and the number is steadily growing. This is Norwegian:
