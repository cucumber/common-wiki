Communication within a team always works better when people can use their spoken language. Cucumber supports "25 spoken languages":../cucumber/tree/master/lib/cucumber/languages.yml. This is Norwegian:
...
*{color:red}Only available in 0.1.99 and above*
