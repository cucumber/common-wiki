...
A <code># language:</code> header on the first line of a feature file tells Cucumber what spoken language to use - for example <code># language: fr</code> for French. If you omit this header, Cucumber will default to English (en), unless you use the <code>--language</code> command line option.
