...
<code>Transform</code> can put in a <code>support/transforms.rb</code> file or any other file under the <code>support</code> directory. Here is an example:
