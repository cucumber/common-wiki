...
h2. Calling steps with tables and strings (multiline arguments)

Sometimes you want to call a step that has been designed to take a table or multiline string as input:
