Most people seem to use cucumber for rails and most of the howtos and documents on the web reflect this. But cucumber is a great tool for testing any kind of web application, no matter what language it was builtin. We could use Selenium, and there are good "howtos":http://wiki.github.com/aslakhellesoy/cucumber/setting-up-selenium for that - but Selenium is slow. What if I want to test a PHP app with cucumber?
