...
<pre><code>cucumber features --scenario "Failed login"</code></pre>
...
If you are using [[Ruby on Rails]] this task is defined for you already.  For more information please see the "detailed page about using rake.":http://wiki.github.com/aslakhellesoy/cucumber/using-rake
