...
Step Definitions start with a "preposition":http://www.merriam-webster.com/dictionary/given or an "conjunction":http://www.merriam-webster.com/dictionary/when, and can be expressed in any of Cucumber's supported [[Spoken languages]]. All Step definitions are loaded (and defined) before Cucumber starts to execute the plain text.
