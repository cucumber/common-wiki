...
Step Definitions start with an "adjective":http://www.merriam-webster.com/dictionary/given or an "adverb":http://www.merriam-webster.com/dictionary/when methods. All Step definitions are loaded (and defined) before Cucumber starts to execute the plain text.
