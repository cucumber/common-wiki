...
h3. Running cucumber steps before any scenario is run

Running cucumber steps once before any scenario can be done with this trick:
...
In reality, this works as a BeforeAll hook and runs only once.

h3. AfterConfiguration
