*{color: red}IMPORTANT*: See Cucumber-Rails' "README":http://github.com/aslakhellesoy/cucumber-rails/blob/master/README.rdoc for updated instructions for Rails3. This page will be updated with Rails3 info later.
