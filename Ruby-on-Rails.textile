...
If your own Rails code is *not* in Git, just replace <code>submodule add</code> with <pre>clone</pre>.
If you're behind a proxy, try to replace <pre>git://</pre> with <pre>http://</pre> and set the <pre>http_proxy</pre> environment variable.
