...
that isn't well formed. "Here is a simple layout":http://github.com/aslakhellesoy/cucumber_rails/raw/master/app/views/layouts/application.html.erb you can use, but I hope you have a better one yourself.
