*{color: red}IMPORTANT*: See Cucumber-Rails' "README":http://github.com/cucumber/cucumber-rails/blob/master/README.md for updated instructions for Rails3. This page will be updated with Rails3 info later.

Cucumber supports Ruby on Rails out of the box. Currently the following Rails versions are tested with "cucumber-rails-test":http://github.com/cucumber/cucumber-rails-test
...
h2. Bootstrap Cucumber-Rails

Cucumber-Rails needs to add a few files to your project:

<pre><code>ruby script/generate cucumber # Rails 2
rails generate cucumber:install # Rails 3
</code></pre>
...
<pre><code>ruby script/generate cucumber --help # Rails 2
rails generate cucumber:install --help # Rails 3</code></pre>
