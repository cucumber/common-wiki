...
*important:* the latest released version of webrat throws an error. Install webrat as a plugin until the gem is updated. Given that you are installing the plugin rather than the gem - make sure you install nokogiri aswell as this is a webrat dependency. 
<pre><code>
