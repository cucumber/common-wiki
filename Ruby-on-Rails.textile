...
As of Cucumber-Rails version 0.5.0 and above, Cucumber-Rails *only* supports Rails 3.x (Rails 2 is *not* supported). See Cucumber-Rails' "README" for installation instructions.
