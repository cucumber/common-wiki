...
class CustomFormatter
  ...
  def initialize(config)
    ...
    config.on_event :test_case_started do |event|
      feature = event.test_cases.first.feature
      io.puts feature.name.upcase
    end
  end
end
```
