...
The env.rb loads the environment and is a good place to move any pertinent code from your old stories/helper.rb.  For example, if you had been monkey-patching module Spec::Story::World to add global story helpers you can move it's contents directly into env.rb.
