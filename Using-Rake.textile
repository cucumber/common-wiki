...
For complex feature runs that you do often it is nice to save the command line arguments as cucumber profiles.  You can read more about Cucumber profiles "here":http://wiki.github.com/aslakhellesoy/cucumber/cucumberyml.  Once you have some profiles defined you can use it in your rake tasks like so:
