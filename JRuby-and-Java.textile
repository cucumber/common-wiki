...
Apache "Maven":http://maven.apache.org/ is a popular build tool for Java. If you're already using Maven you might be interested in running Cucumber with Maven too. Check out the "cucumber_java":http://github.com/aslakhellesoy/cucumber_java project, which has a Maven plugin that lets you run Cucumber from Maven.
...
<pre><code><target name="cucumber" description="Runs all the cucumber tests">
...
This is taken from "this blog post":http://csausdev.wordpress.com/2009/05/12/cucumber-jruby-and-ant/. This will create JUnit output if you use the <code>Sensis::JUnitFormatter</code> which you can get "here":http://csausdev.wordpress.com/2009/05/12/junit-formatter-for-cucumber/. (This formatter may be included in Cucumber in a future release).
