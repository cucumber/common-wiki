...
Apache "Maven":http://maven.apache.org/ is a popular build tool for Java. If you're already using Maven you might be interested in running Cucumber with Maven too. Check out the "cuke4duke":http://github.com/aslakhellesoy/cuke4duke project, which has a Maven plugin that lets you run Cucumber from Maven.
