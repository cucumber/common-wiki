...
If you fail a Lighthouse ticket without following the "Before you ask" guidelines below, your ticket may be closed as invalid. If that happens, just comment on the ticket with the missing information to have it reopened.
...
Use "troubleshooting":http://wiki.github.com/aslakhellesoy/cucumber/troubleshooting tips 
...
* What relevant code you have. Don't _describe_ your code in twelve furlongs of prose, just show it. Please don't paste code in emails, use: "http://gist.github.com/":http://gist.github.com/
