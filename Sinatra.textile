...
You can use Cucumber with "Sinatra":http://github.com/bmizerany/sinatra and "Webrat":http://github.com/brynary/webrat/tree/master!
...
You may have to set the app_file in your app file. Otherwise Sinatra (at least version 0.9.1.1) won't find the views or layouts (see "this irc log":http://irclogger.com/sinatra/2009-05-08) e.g.,
