...
*Be warned: Cucumber 0.8.4 is not yet in Rubygems, so to use cucumber/rspec/doubles you will need to install directly from http://github.com/aslakhellesoy/cucumber.git*
