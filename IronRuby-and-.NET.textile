...
<pre>SVN for IronRuby is old, do refer to http://wiki.github.com/ironruby/ironruby/building for current build process</pre>
...
<pre>rake aborted!
no such file to load -- pathname2</pre>

If you see this message, simply install the 'pathname2' gem:

<pre>gem install pathname2</pre>
